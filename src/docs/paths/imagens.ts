...
const ImagensPaths: Paths = {
	...
	"/{finalidade}/imagem": {
		post: {
			...
			description: "Envia várias imagens e retorna seus caminhos na API.",
			security: [{ BearerAuth: [] }],
			requestBody: {
				content: {
					"multipart/form-data": {
	...
	"/{finalidade}/{id_finalidade}/imagem/{caminho}": {
		put: {
			tags: ["Imagens"],
			summary: "Confirma o envio de uma imagem",
			description: "Envia uma única imagem confirma seu salvanto na API.",
			security: [{ BearerAuth: [] }],
			requestBody: {
				content: {
					"multipart/form-data": {
